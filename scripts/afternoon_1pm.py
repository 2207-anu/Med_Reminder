"""
Afternoon reminder — 1:00 PM
python scripts/afternoon_1pm.py

Cron: python scripts/setup_windows_tasks.py  →  MedRemind-Afternoon-1PM
"""
...
def main():
    ...
    patients = get_afternoon_patients()
    if not patients:
